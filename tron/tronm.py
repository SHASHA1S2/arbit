...
def hypoinit():
	hypothesis[0][0]=1
	hypothesis[0][1]=hypothesis[0][7]=0.5
	hypothesis[1][2]=1
	hypothesis[1][3]=hypothesis[1][1]=0.5
	hypothesis[2][4]=1
	hypothesis[2][3]=hypothesis[2][5]=0.5
	hypothesis[3][6]=1
	hypothesis[3][7]=hypothesis[3][5]=0.5
...
def main():
	...
	#printboard()
		...
		key=evaluate(hypothesis,arrsensor)
